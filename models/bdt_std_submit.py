...
for i, pars in enumerate(itertools.product(*param_list)):
    ...
    # model_fname
    arguments.append(
        '/nfs/raid13/babar/dchao/KaggleCS155/models/bdt/{0}.pkl'.format(i)
    )
    ...
    try:
        ...
        submit_file.writelines(['universe = vanilla\n',
                                ...
                                'output = '+model_path+'/models/logs/bdt_'+str(i)+'.out\n',
                                'error = '+model_path+'/models/logs/bdt_'+str(i)+'.error\n',
                                'log = '+model_path+'/models/logs/bdt_'+str(i)+'.log\n',
